      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-2">
            ...
            {/* Theme Toggle - Posicionado à esquerda */}
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg hover:bg-blue-700/50 dark:hover:bg-gray-700/50 transition-colors hidden md:flex"
          ...
          <div className="flex items-center">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg hover:bg-blue-700/50 dark:hover:bg-gray-700/50 transition-colors md:hidden"
              aria-label="Alternar tema"
            >
              {theme === 'dark' ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
            </button>
            ...
            {/* Navigation Desktop - Posicionado à direita */}
